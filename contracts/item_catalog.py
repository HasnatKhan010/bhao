...
ITEMS: tuple[ItemDef, ...] = (
    ...
    ItemDef(
        ...
        92.00,
        0.010,
        ("Bread Plain (Medium)", "Bread (Medium Size)"),
    ),
    ItemDef(
        "006",
        "Chapati Plain",
        ...
        18.00,
        0.012,
        ("Chapati Plain", "Chapati / Naan (Plain)"),
    ),
    ItemDef(
        "007",
        "Milk Fresh",
    ...
    ItemDef(
        ...
        2850.00,
        0.006,
        ("Milk Powdered (Tin)", "Milk Powdered Nido Tin"),
    ),
    ItemDef(
        "009",
        "Curd",
    ...
    ItemDef(
        "011",
        "Cooking Oil Branded 5 Litre Tin",
        "5 Litre",
        "litre",
        5.0,
        "cooking_oil",
    ...
    ItemDef(
        "012",
        "Vegetable Ghee Branded 2.5 Kg Tin",
        "2.5 Kg",
        "kg",
        2.5,
        "cooking_oil",
    ...
    ItemDef(
        ...
        385.00,
        0.030,
        ("Chicken Farm Broiler Live", "Chicken (Farm Broiler, Live)"),
    ),
    ItemDef(
        "015",
        "Chicken Farm Broiler Dressed",
        "1 Kg",
        "kg",
        1.0,
        "meat_poultry",
        ...
        645.00,
        0.028,
        ("Chicken Farm Broiler Dressed", "Chicken Meat (Farm Broiler)"),
    ),
    ItemDef(
        "016",
        "Eggs Farm",
    ...
    ItemDef(
        ...
        1780.00,
        0.011,
        ("Mutton With Bone", "Mutton (With Bone)"),
    ),
    ItemDef(
        "019",
        "Onions",
    ...
    ItemDef(
        ...
        355.00,
        0.020,
        ("Apples Kala Kulu", "Apples (Kala Kulu)"),
    ),
    ItemDef(
        "029",
        "Oranges Malta",
    ...
    ItemDef(
        ...
        46.00,
        0.005,
        ("Salt Iodised", "Salt (Iodised, Powder)"),
    ),
    ItemDef(
        "035",
        "Red Chillies Powder",
        ...
        985.00,
        0.015,
        ("Red Chillies Powder", "Chillies (Powder)"),
    ),
    ItemDef(
        "036",
        "Turmeric Powder",
    ...
    ItemDef(
        ...
        1360.00,
        0.015,
        ("Cumin White Powder", "Cumin White (Powder)"),
    ),
    ItemDef(
        "038",
        "Gram Flour Besan",
    ...
    ItemDef(
        ...
        272.00,
        0.014,
        ("Pulse Gram Washed", "Pulse Gram (Washed)"),
    ),
    ItemDef(
        "040",
        "Pulse Moong Washed",
    ...
    ItemDef(
        ...
        335.00,
        0.015,
        ("Pulse White Gram Kabuli", "Pulse White Gram (Kabuli)"),
    ),
    ItemDef(
        "044",
        "Match Box",
        ...
        2.00,
        0.030,
        ("Match Box", "Match Box (Ten Units)"),
        "the Rs-2 extreme of the scale spread",
    ),
    ItemDef(
        "045",
        "Toilet Soap Branded 115 gm",
        "Each",
        "each",
        1.0,
        "personal_care",
        ...
        118.00,
        0.006,
        ("Toilet Soap Branded 115 gm", "Toilet Soap LIFEBUOY 115 gm"),
    ),
    ItemDef(
        "046",
        "Detergent Branded 1 Kg",
        "Each",
        "each",
        1.0,
        "household",
        ...
        645.00,
        0.008,
        ("Detergent Branded 1 Kg", "Detergent (Surf, 1 Kg)"),
    ),
    ItemDef(
        "047",
        "Petrol Super",
    ...
    ItemDef(
        ...
        268.00,
        0.0002,
        ("Diesel Hi Speed", "Diesel (Hi Speed)"),
    ),
    ItemDef(
        "049",
        "Kerosene Oil",
    ...
    ItemDef(
        ...
        54.00,
        0.0002,
        ("Electricity Charges Per Unit", "Electricity Charges (Average Per Unit)"),
    ),
    ItemDef(
        "051",
        "Gas Charges",
    ...
    ItemDef(
        "059",
        "Vegetable Ghee Superior 1 kg Pouch",
        "Each",
        "each",
        1.0,
        "cooking_oil",
